...
#CELESTA_PROPERTIES.put('database.connection', 'jdbc:oracle:thin:celesta/123@localhost:1521:XE')
#CELESTA_PROPERTIES.put('database.connection', 'jdbc:sqlserver://localhost;databaseName=celestaunit;user=sa;password=123')
