...
public class ParserTest extends AbstractParsingTest {
    ...
    public void test1() throws Exception {
        ...
        assertInstanceOf(BinaryColumn.class, c);
        assertTrue(c.isNullable());
        ...
        assertInstanceOf(DateTimeColumn.class, c);
        assertTrue(c.isNullable());
