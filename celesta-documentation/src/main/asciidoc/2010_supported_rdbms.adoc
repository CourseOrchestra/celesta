...
* Поддержка типа данных `TIMESTAMP WIH TIMEZONE`, необходимая для Celesta, появилась начиная только с 4-й версии. По состоянию на октябрь 2019 года версия 4.0 находится в статусе beta --- это минимальная версия, необходимая для работы Celesta.
