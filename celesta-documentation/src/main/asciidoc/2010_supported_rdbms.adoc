...
image::img/Mssql.jpg[width=80,role="left"]
== MS SQL Server
...
image::img/Ora.jpg[width=80,role="left"]
== Oracle
...
image::img/Postgre.png[width=120,role="left"]
== PostgreSQL
...
image::img/H2.png[width=120,role="left"]
== H2
