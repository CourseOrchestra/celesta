...
It can be utilized by establishing a connection to an external dependancy via https://search.maven.org/search?q=a:celesta-parent[Maven Central], and also has its own https://github.com/CourseOrchestra/spring-boot-starter-celesta[Spring Boot starter].
