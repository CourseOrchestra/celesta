...
** During the `generate-resources` phase -> `generated-resources/score/score.files`
** During the `generate-test-resources` phase -> `generated-test-resources/score/score.files`
