...
*Do not use more complex filters if the simplier one is enough!*
...
Iteration methods send queries and open JDBC `ResultSet` used for futher movement between entries.
